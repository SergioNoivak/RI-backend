            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(i < /*documentos.length*/ 2)) return [3 /*break*/, 4];
                        filename = documentos[i];
                        return [4 /*yield*/, leitor.tatarTXT("C:/Users/Sergio Souza Novak/Documents/IF GOIANO/recuperação da informação/trabalho final/artigos/transformados/" + filename, [], "C:/Users/Sergio Souza Novak/Documents/IF GOIANO/recuperação da informação/trabalho final/artigos/metadata/" + filename)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, TratadorTF_IDF_1.TratadorTF_IDF.calcularIDF("C:/Users/Sergio Souza Novak/Documents/IF GOIANO/recuperação da informação/trabalho final/artigos/ifd/tabelaGeral.json", 2)];
                    case 5:
                        _a.sent();
                        i = 0;
                        _a.label = 6;
                    case 6:
                        if (!(i < /*documentos.length*/ 2)) return [3 /*break*/, 9];
                        filename = documentos[i];
                        return [4 /*yield*/, TratadorTF_IDF_1.TratadorTF_IDF.calcularTF("C:/Users/Sergio Souza Novak/Documents/IF GOIANO/recuperação da informação/trabalho final/artigos/metadata/" + filename, "C:/Users/Sergio Souza Novak/Documents/IF GOIANO/recuperação da informação/trabalho final/artigos/tfs/" + filename, filename)];
                    case 7:
                        _a.sent();
                        _a.label = 8;
                    case 8:
